...
function _PriceDistribution(Plot,data){return(
Plot.plot({
  marks: [
...
export default function define(runtime, observer) {
  ...
  main.variable(observer("viewof PriceDistribution")).define("viewof PriceDistribution", ["Plot","data"], _PriceDistribution);
  main.variable(observer("PriceDistribution")).define("PriceDistribution", ["Generators", "viewof PriceDistribution"], (G, _) => G.input(_));
  ...
  main.variable(observer()).define(["Plot","data"], _63);
  main.variable(observer()).define(["Plot","data"], _64);
  main.variable(observer()).define(["Plot","data"], _65);
